...
public class TextSelectedListAdapter extends BaseAdapter {
	...
	public TextSelectedListAdapter(Context context) {
		Log.i("TextSelectedListAdapter","Inside textSelected List Adapter constructor");
		mContext = context;
		Log.i("TextSelectedListAdapter","Inside textSelected List Adapter constructor after setting context");
	}
