...
public class GetIndividualParkingSpotDetails extends ListActivity {
	...
	static final String getParkingSpotsurl = "http://192.168.1.25:80/easypark/getparkingspots.php";
	static final String updateParkingSpoturl = "http://192.168.1.25:80/easypark/updateparkingspot.php";
	...
	/*	parkingSpotMapList = new ArrayList<LinkedHashMap<String, String>>();
	    ...
	    {    
	    	...
	    	TextSelectedView l_v = (TextSelectedView)v;
	    	Log.i("GetIndividualParkingSpotDetails","Inside onlistItemclick after textselectedview");
	    	if (l_v.getSelected()) {
