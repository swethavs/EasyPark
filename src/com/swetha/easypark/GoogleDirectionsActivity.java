...
public class GoogleDirectionsActivity extends FragmentActivity implements LocationListener  {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("GoogleDirectionsActivity","Inside Oncreate");
        ...
        Log.e("GoogleDirectionsActivity","After Setting tolat, tolng, toPosition" +tolat + "\n"+tolng + "\n"+toPosition);
	   ...
	   // Getting the name of the provider that meets the criteria
        ...
        if(provider!=null && !provider.equals("")){
            ...
            locationManager.requestLocationUpdates(provider, 20000, 1, GoogleDirectionsActivity.this);
